...
class RegisterTest(unittest.TestCase):
    ...
    def test_new_user(self):
        ...
        middle_name = driver.find_element_by_id('lastname')
        last_name = driver.find_element_by_id('lastname')
        email_address = driver.find_element_by_id('email_address')
        news_letter_subscrition = driver.find_element_by_id('is_subscribed')
        ...
        and last_name.is_enabled() and email_address.is_enabled() and news_letter_subscrition.is_enabled()
